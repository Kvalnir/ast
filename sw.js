 ...
 */
const VERSION = 'v43';  // v43: resume where you left off, hint tally, Name it, master drills
...
// Everything the eight pages need to run with the network off — both tiers. `./` is left
