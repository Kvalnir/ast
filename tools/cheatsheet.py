...
<meta name="description" content="The nine techniques on one page: what fires each one, what it lets you delete, and where it goes wrong.">
...
<div class="crib">
  ...
  <header class="cribhead">
    ...
    <h1>Nine shapes, <em>one page</em>.</h1>
