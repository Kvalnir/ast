...
TECH = [
    ...
    dict(
        ...
        geo=[seg("6-2", "7-2"), seg("6-7", "7-7"),
             seg("6-2", "6-7", "cross"), seg("7-2", "7-7", "cross")],
...
<body data-page="cheatsheet" data-tier="advanced">
<div class="crib">
  ...
  <div class="sitebar">
    ...
    <nav>
      ...
      <a data-page="cheatsheet" aria-current="page" href="cheatsheet.html">Cheat sheet</a>
      <a data-page="gallery" href="gallery.html">Gallery</a>
