...
<div class="crib">
  ...
  <header class="cribhead">
    ...
    <p class="lede">The tier above the nine, reduced to what fires it, what it earns and — new on this page — <b>why it is true</b>. A chain you cannot reconstruct is a chain you will not act on. <a href="master.html">The lessons</a> are the long version; the <a href="cheatsheet.html">Advanced crib</a> still comes first, because everything on it still comes first.</p>
